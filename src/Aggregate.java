...
public class Aggregate extends Operator {
    ...
    int afield;
    int gfield;
    Aggregator.Op aop;//聚合操作
    Aggregator agg;//聚合操作器
    ...
    public Aggregate(OpIterator child, int afield, int gfield, Aggregator.Op aop) {
        ...
        this.aop=aop;
        Type gtype;
        if(gfield==Aggregator.NO_GROUPING)// 2023.5.2
            gtype=null;
        else
        ...
        it=agg.iterator();// .iterator是new一个迭代器出来
    ...
    public TupleDesc getTupleDesc() {
        ...
        if(gfield<=-1){
            ...
            fieldAr[0]=child.getTupleDesc().getFieldName(afield)+'('+aop.toString()+')';
        }
        else{
            ...
            fieldAr[1]=child.getTupleDesc().getFieldName(afield)+'('+aop.toString()+')';
        }
